...
class SNAKE:
    def __init__(self):
        ...
        self.tail = pygame.image.load("images/tail_right.png").convert_alpha()
    ...
    def update_tail(self):
        ...
        elif tail_relation == Vector2(-1,0): self.tail = pygame.image.load("images/tail_right.png")
...
class FRUIT:
    ...
    def draw_fruit(self):
        ...
        # pygame.draw.rect(surface, (8, 4, 219),fruit_rect)
            ...
            if row % 2 == 0:
                for col in range (cell_number):
                    if col % 2 ==0:
                        ...
                        pygame.draw.rect(surface, g_color, grass_rect)
            else:
                for col in range (cell_number):
                    if col % 2 != 0:
                        grass_rect = pygame.Rect(col * cell_size, row * cell_size, cell_size, cell_size)
...
cell_size = 40
cell_number = 15
surface = pygame.display.set_mode((cell_number*cell_size, cell_number*cell_size))
clock = pygame.time.Clock() 
apple = pygame.image.load("apple.png")
game_font = pygame.font.SysFont("freesansbold", 30)
